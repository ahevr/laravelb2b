            ...
            <form action="{{route("admin.products.update",$product)}}" method="post" enctype="multipart/form-data">
                ...
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">{{$product->product_name}} Adlı Ürüne Ait Genel Bilgiler</h4>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6">
                    ...
                    <hr>
                    <div class="card-header">
                        <h4 class="card-title">Özellikleri</h4>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-lg-4">
                    ...
                    <hr>
                    <div class="card-header">
                        <h4 class="card-title">Medya</h4>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            <div class="card-body">
                                <div class="input-upload">
                                    <img src="{{asset("app/admin/uploads/urunler/".$product->image) }}">
                    ...
                    <div>
                        <div class="d-flex justify-content-center">
                            <button id="submit" type="submit" class="btn btn-primary mb-3">Güncelle</button>
                        </div>
                    </div>
                </div>
